                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1">
                                            ...
                                            <a class="dropdown-item" href="<?= site_url('index.php/Admin/ver_data_sesuai/'.$row->id_siswa) ?>">Setujui</a>
                                            <a class="dropdown-item" href="<?= site_url('index.php/Admin/ver_proses/'.$row->id_siswa) ?>">Diajukan</a>
                                            <a class="dropdown-item" href="<?= site_url('index.php/Admin/ver_tidak_sesuai/'.$row->id_siswa) ?>">Revisi</a>
                                            <a class="dropdown-item" href="<?= site_url('index.php/Admin/ver_tolak_permanen/'.$row->id_siswa) ?>">Tolak Permanen</a>
                                        </div>
                                    </div>
                                    </td>
