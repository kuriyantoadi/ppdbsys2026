                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            <h5 class="mb-0">Halaman Login Daftar Ulang</h5>
                                            <p class="text-muted mt-2">Masuk Untuk Informasi Lebih Lanjut</p>
                                        </div>
                                        
                                        <!-- <form class="custom-form mt-4 pt-2" action="" method=""> -->
           				    		    <br><?= $this->session->flashdata('msg') ?>

                                        <?= form_open('index.php/Pendaftar/siswa_login') ?>
                                        <form class="m-t-40" novalidate>
                                            <div class="mb-3">
                                                <label class="form-label" for="nisn">NISN Siswa</label>
                                                <input type="text" class="form-control" id="nisn" placeholder="Masukan Username" name="nisn_siswa" value="" required>
