<?php include 'op-layouts/head-main.php'; ?>

<head>

    <title>PPDB SMKN 1 Kragilan</title>
    <?php include 'op-layouts/head.php'; ?>
    <?php include 'op-layouts/head-style.php'; ?>

</head>

<?php include 'op-layouts/body.php'; ?>

<!-- Begin page -->
<div id="layout-wrapper">

    <?php include 'op-layouts/menu.php'; ?>
...
<!-- Right Sidebar -->
<?php include 'op-layouts/right-sidebar.php'; ?>
<!-- /Right-bar -->

<!-- JAVASCRIPT -->

<?php include 'op-layouts/vendor-scripts.php'; ?>
