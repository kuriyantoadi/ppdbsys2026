                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item bg-soft-light border-start border-end" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="d-none d-xl-inline-block ms-1 fw-medium">Operator Adm</span>
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            <li class="menu-title" data-key="t-menu">Seleksi Administrasi PPDB</li>
                            <li>
                                <a href="<?= base_url() ?>index.php/Op_adm/index">
                            ...
                            <li>
                                <a href="<?= base_url() ?>index.php/Op_adm/siswa_tampil">
                                    <i class="dripicons-document-edit"></i>
                                    <span data-key="">Seleksi Administrasi</span>
                                </a>
                            </li>
