                        ...
                        <div class="card">
                           <?php foreach ($tampil as $row) { ?>
                            ...
                            <div class="card-header">
                                ...
                                <a href="<?= site_url('index.php/Op_wawancara/wawancara_belum/'.$row->id_siswa) ?>" class="btn btn-sm btn-secondary" onclick="return confirm('Anda yakin belum wawancara dari data siswa <?= $row->nama_siswa ?> ?')">Belum Wawancara</a>
                                        ...
                                        <div class="table">
                                            <table class="table mb-0 table-bordered table-hover">
                                                ...
                                                <tbody>
                                                  ...
                                                  <?= form_open('index.php/Op_wawancara/wawancara_note') ?>
