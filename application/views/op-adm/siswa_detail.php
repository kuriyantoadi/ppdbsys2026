                        ...
                        <div class="card">
                           <?php foreach ($tampil as $row) { ?>
                            ...
                            <div class="card-header">
                                <a href="<?= site_url('index.php/Op_adm/siswa_tampil') ?>" class="btn btn-dark waves-effect waves-light btn-sm">Kembali</a>
                                 <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1">
                                        <a class="dropdown-item" href="<?= site_url('index.php/Op_adm/adm_belum/'.$row->id_siswa) ?>">Belum</a>
                                        ...
                                        <div class="table">
                                            <table class="table mb-0 table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>Status Seleksi Administrasi</th>
                                                        <td>
