                             ...
                             <br><?= $this->session->flashdata('msg') ?>
                               <!-- <a href="<?= site_url('index.php/Admin/siswa_tambah') ?>" type="button" class="btn btn-info btn-sm mb-1">Tambah</a> -->
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="<?= site_url('index.php/Op_adm/adm_semua') ?>" type="button" class="btn btn-primary btn-sm">Semua Jurusan</a>
                                    <a href="<?= site_url('index.php/Op_adm/adm_akl') ?>" type="button" class="btn btn-primary btn-sm">AKL</a>
                                    <a href="<?= site_url('index.php/Op_adm/adm_mplb') ?>" type="button" class="btn btn-primary btn-sm">MPLB</a>
                                    <a href="<?= site_url('index.php/Op_adm/adm_tjkt') ?>" type="button" class="btn btn-primary btn-sm">TJKT</a>
                                    <a href="<?= site_url('index.php/Op_adm/adm_pplg') ?>" type="button" class="btn btn-primary btn-sm">PPLG</a>
                                    <a href="<?= site_url('index.php/Op_adm/adm_to') ?>" type="button" class="btn btn-primary btn-sm">TO</a>
                                    <a href="<?= site_url('index.php/Op_adm/adm_tm') ?>" type="button" class="btn btn-primary btn-sm">TM</a>
                                </div>
                            </div><!-- end col -->
                        </div><!-- end row -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1">
                                            <a class="dropdown-item" href="<?= site_url('index.php/Op_adm/siswa_detail/'.$row->id_siswa) ?>">Detail</a>
                                            <a class="dropdown-item" href="<?= site_url('index.php/Op_adm/adm_belum/'.$row->id_siswa) ?>">Belum Seleksi</a>
                                            <a class="dropdown-item" href="<?= site_url('index.php/Op_adm/adm_data_sesuai/'.$row->id_siswa) ?>">Data Sesuai</a>
                                        </div>
                                    </div>
                                    </td>
